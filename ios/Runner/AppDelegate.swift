...
//     BTAppContextSwitcher.setReturnURLScheme("com.nahrdev.shababek.braintree")
...
//     if url.scheme?.localizedCaseInsensitiveCompare("com.nahrdev.shababek.braintree") == .orderedSame {
