...
class PsColors {
  ...
  /// Primary Color
  static const Color _c_primary_50 = Color(0xFFf2f2f2);
  ...
  static const Color _c_primary_500 = Color(0xFF7d0d35);
  ...
  static const Color _c_sold_out = Color(0xFF7d0d35);
  ...
  static void _loadLightColors() {
    ...
    textColor1 = const Color(0xFF7d0d35);
    ...
    /// Button Color
    ///
    buttonColor = const Color(0xFF7d0d35);
    bottomNavigationSelectedColor = const Color(0xFF7d0d35);
    activeColor = const Color(0xFF7d0d35);
    backArrowColor = const Color(0xFF7d0d35);
