...
class SearchProductFeaturedProvider extends PsProvider {
  SearchProductFeaturedProvider(
      {required ProductRepository? repo, this.psValueHolder, int limit = 0})
      : super(repo, limit) {
    _repo = repo;
    print('SearchProductFeaturedProvider : $hashCode');
  ...
  Future<void> initSubscription() async {
    ...
    subscription =
      ...
      print('**** SearchProductFeaturedProvider ${resource.data!.length}');
