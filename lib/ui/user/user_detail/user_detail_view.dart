            ...
            children: [
              if (widget.userProvider.psValueHolder!.loginUserId !=
                ...
                Container(
                  child: MaterialButton(
                    ...
                    color: PsColors.buttonColor,
                    child: widget.userProvider.user.data!.isFollowed ==
                            PsConst.ONE
                        ? Text(
                    ...
                    onPressed: () async {
                      if (await Utils.checkInternetConnectivity()) {
                        Utils.navigateOnUserVerificationView(
                          ...
                          final PsResource<User> _user = await widget
                              .userProvider
              ...
              if (widget.userProvider.psValueHolder!.loginUserId !=
                ...
                Container(
                  ...
                  child: InkWell(
                    onTap: () async {
                      Utils.psPrint('Buyer user id : ' + widget.data!.userId!);
                      Utils.psPrint('Seller user id : ' +
                          widget.userProvider.psValueHolder!.loginUserId!);
                      await showDialog<dynamic>(
                          context: context,
                          builder: (BuildContext context) {
                            return RatingInputDialog(
                              buyerUserId: widget.data!.userId,
                              sellerUserId: widget
                                  .userProvider.psValueHolder!.loginUserId,
                            );
                          });
                    ...
                    child: Container(
                      ...
                      child: Ink(
                        ...
                        child: Text(
                          Utils.getString(
                              context, 'chat_view__give_review_button'),
                          style: Theme.of(context)
                              .textTheme
                              .labelLarge!
                              .copyWith(color: PsColors.textColor4),
