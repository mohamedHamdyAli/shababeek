      ...
      child: ChangeNotifierProvider<UserProvider>(
        ...
        child: Consumer<UserProvider>(builder:
          ...
          passwordConfirmController = TextEditingController(
              text: provider.psValueHolder!.userPasswordConfirmToVerify);
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        _TextFieldWidget(
                          ...
                          passwordConfirmText: passwordConfirmController,
                        ),
                        const SizedBox(
          ...
          onChanged: (bool? value) {
            setState(() {
              updateCheckBox(
                  ...
                  widget.passwordConfirmTextEditingController);
            });
          },
        ),
        Expanded(
...
void updateCheckBox(
  ...
  if (isCheckBoxSelect) {
    ...
    provider.psValueHolder!.userPasswordConfirmToVerify =
    ...
    return Column(
      children: <Widget>[
        ...
        Container(
          margin: _marginEdgeInsetWidget,
          child: TextField(
            controller: widget.passwordConfirmText,
            obscureText: true,
            style: Theme.of(context).textTheme.button!.copyWith(),
            decoration: InputDecoration(
                border: const OutlineInputBorder(
                ...
                filled: true,
                fillColor: PsColors.cardBackgroundColor,
                hintText: Utils.getString(context, 'confirm__password'),
                hintStyle: Theme.of(context).textTheme.button!.copyWith(
                    color: Utils.isLightMode(context)
                        ? PsColors.textPrimaryLightColor
                        : PsColors.primaryDarkGrey),
        ...
        onPressed: () async {
          if (widget.nameTextEditingController!.text.isEmpty) {
            ...
            callWarningDialog(context,
              ...
              .passwordConfirmTextEditingController!.text.isEmpty) {
            callWarningDialog(
                context,
                Utils.getString(
                    context, 'warning_dialog__input_confirm_password'));
          } else if (widget.passwordTextEditingController!.text !=
              widget.passwordConfirmTextEditingController!.text) {
            callWarningDialog(
                context,
                Utils.getString(
                    context, 'warning_dialog__input_password_not_match'));
          } else {
