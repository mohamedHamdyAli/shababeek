...
import 'package:flutterbuyandsell/ui/common/dialog/success_item_dialog.dart';
...
class ItemOfferEntryView extends StatefulWidget {
  const ItemOfferEntryView({
    Key? key,
    this.flag,
    this.item,
...
class _ItemEntryViewState extends State<ItemOfferEntryView> {
  ...
  final TextEditingController userInputListingPhone = TextEditingController();
  final TextEditingController userInputListingEmail = TextEditingController();
                        ...
                        children: <Widget>[
                          ...
                          Consumer<ItemEntryProvider>(builder:
                            ...
                            if (provider.item != null &&
                              ...
                              if (bindDataFirstTime) {
                                userInputListingTitle.text =
                                    provider.item!.title!;
                                userInputListingPhone.text =
                                    provider.item!.phone!;
                                userInputListingEmail.text =
                                    provider.item!.email!;
                            ...
                            return AllControllerTextWidget(
                              ...
                              userInputListingPhone: userInputListingPhone,
                              userInputListingEmail: userInputListingEmail,
...
class AllControllerTextWidget extends StatefulWidget {
  const AllControllerTextWidget({
    ...
    this.userInputListingPhone,
    this.userInputListingEmail,
  ...
  final TextEditingController? userInputListingPhone;
  final TextEditingController? userInputListingEmail;
...
class _AllControllerTextWidgetState extends State<AllControllerTextWidget> {
  ...
  Widget build(BuildContext context) {
            ...
            onPressed: () async {
              if ( //Utils.showUI(valueHolder!.image) &&
                ...
                showDialog<dynamic>(
                  ...
                  widget.userInputListingPhone!.text == '') {
                showDialog<dynamic>(
                    context: context,
                    builder: (BuildContext context) {
                      return WarningDialog(
                        message: Utils.getString(
                            context, 'item_entry__need_listing_phone'),
                        onPressed: () {},
                      );
                    });
              ...
              // }
                ...
                if (widget.flag == PsConst.ADD_NEW_ITEM) {
                  ...
                  final ItemEntryParameterHolder itemEntryParameterHolder =
                    ...
                    adsStatus: widget.provider!.checkOrNotShop,
                    isSoldOut: '', //must be ''
                    title: widget.userInputListingTitle!.text,
                    phone: widget.userInputListingPhone!.text,
                    email: widget.userInputListingEmail!.text.trim(),
    ...
    return Column(children: <Widget>[
      ...
      PsTextFieldWidget(
        //  height: 46,
        titleText: Utils.getString(context, 'item_entry__listing_phone'),
        textAboutMe: false,
        hintText: Utils.getString(context, 'item_entry__listing_phone'),
        textEditingController: widget.userInputListingPhone,
        isStar: true,
      ),
      PsTextFieldWidget(
        //  height: 46,
        titleText: Utils.getString(context, 'item_entry__listing_email'),
        textAboutMe: false,
        hintText: Utils.getString(context, 'item_entry__listing_email'),
        textEditingController: widget.userInputListingEmail,
        isStar: false,
      ),
      ...
      Column(
        children: <Widget>[
          ...
          if (Utils.showUI(valueHolder!.dealOptionRemark))
            PsTextFieldWidget(
              titleText: Utils.getString(context, 'item_entry__remark'),
              textAboutMe: false,
              hintText: Utils.getString(context, 'item_entry__remark_hour'),
              textEditingController: widget.userInputDealOptionText,
              isStar: false,
            )
        ],
      ),
      ...
      if (Utils.showUI(valueHolder!.adsStatus))
        BusinessModeCheckbox(
          provider: widget.provider,
          onCheckBoxClick: () {
            setState(() {
      ...
      if (Utils.showUI(valueHolder!.highlightInfo))
        PsTextFieldWidget(
          ...
          hintText:
              Utils.getString(context, 'item_entry__highlight_info_title'),
          textAboutMe: false,
...
class AdsStatusCheckbox extends StatefulWidget {
  const AdsStatusCheckbox(
      {required this.provider, required this.onCheckBoxClick});
  ...
  @override
  _AdsStatusCheckbox createState() => _AdsStatusCheckbox();
}

class _AdsStatusCheckbox extends State<AdsStatusCheckbox> {
  @override
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        Padding(
          padding: const EdgeInsets.only(left: PsDimens.space16),
          child: InkWell(
            child: Text(Utils.getString(context, 'item_entry__is_featured'),
                style: Theme.of(context).textTheme.subtitle2),
            onTap: () {
              FocusScope.of(context).requestFocus(FocusNode());
              widget.onCheckBoxClick();
