    ...
    return Column(
      ...
      children: <Widget>[
        ...
        if (Utils.showUI(itemDetail.psValueHolder?.highlightInfo) &&
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            ...
                            Text(
                              Utils.getString(context, 'Open_Link'),
                              style: Theme.of(context)
                                  .textTheme
                                  .bodyLarge!
                                  .copyWith(
          ...
          Container(),
        if (itemDetail.itemDetail.data!.email != '')
          Container(
            // width: 100,
            child: Padding(
              padding: const EdgeInsets.all(12.0),
              child: Text(
                Utils.getString(context, 'edit_profile__email') +
                    ': ' +
                    '${itemDetail.itemDetail.data!.email}',
                style: Theme.of(context).textTheme.bodyLarge!.copyWith(
                    letterSpacing: 0.8,
                    fontSize: 14,
                    height: 1.3,
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        if (widget.provider.itemDetail.data!.phone != null &&
                            widget.provider.itemDetail.data!.phone != '')
                          Visibility(
                              visible: true,
                              child: Container(
                                margin: const EdgeInsets.only(
                                ...
                                child: PSButtonWithIconWidget(
                                  ...
                                  onPressed: () async {
                                    if (await canLaunchUrl(Uri.parse(
                                        'tel://${widget.provider.itemDetail.data!.phone}'))) {
