...
class ProductListFeaturedWithFilterView extends StatefulWidget {
  const ProductListFeaturedWithFilterView(
      {Key? key,
  ...
  @override
  _ProductListFeaturedWithFilterViewState createState() =>
      _ProductListFeaturedWithFilterViewState();
}

class _ProductListFeaturedWithFilterViewState
    extends State<ProductListFeaturedWithFilterView>
