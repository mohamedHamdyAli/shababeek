      ...
      if (_psAppInfo.status == PsStatus.SUCCESS) {
        ...
        if (_psAppInfo.data!.itemUploadConfig != null) {
          await provider.replaceItemUploadConfig(
              ...
              _psAppInfo.data!.itemUploadConfig!.adsStatus ?? '',
...
// class SplachAnimated extends StatefulWidget {
//   @override
//   State<SplachAnimated> createState() => _SplachAnimatedState();
// }

// class _SplachAnimatedState extends State<SplachAnimated>
...
//   @override
//   Widget build(BuildContext context) {
//     return Lottie.asset('assets/lottie/data.json', controller: _controller,
