                    ...
                    children: [
                      Container(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                                Utils.getString(context, 'Package__title'),
                        ...
                        child: SizedBox(
                          ...
                          child: GridView.builder(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              return PackageItem(
                                package: provider.packageList.data![index],
                                ...
                                onTap: () {
                                  ...
                                  final String? pacPrice = provider
                                      .packageList.data![index].price
                                      .toString();
                                  final String? paceId = provider
                                      .packageList.data![index].packageId;
                                  final String? url =
                                      'https://shababeknew.nahrdev.com/index.php/pymentview?user_id=$loginUserId&package_id=$paceId&price=$pacPrice';
                            ...
                            itemCount: provider.packageList.data!.length,
                            gridDelegate:
