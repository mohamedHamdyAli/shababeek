...
import 'package:flutterbuyandsell/ui/item/entry/item_offer_entry_container.dart';
...
import 'package:flutterbuyandsell/ui/package/payment_screen.dart';
...
import 'package:flutterbuyandsell/ui/item/ads/item_ads.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case '${RoutePaths.paymentWebView}':
      return MaterialPageRoute<dynamic>(builder: (BuildContext context) {
        final Object? args = settings.arguments;
        final String paymentUrl = (args as String? ?? String) as String;
        return CheckOutWebView(urlShipment: paymentUrl);
      });
    ...
    case '${RoutePaths.adsItemsList}':
      return MaterialPageRoute<dynamic>(builder: (BuildContext context) {
        final Object? args = settings.arguments;
        final Ads ads = (args as Ads? ?? Ads) as Ads;
        return AdsScreen(
    ...
    case '${RoutePaths.itemOfferEntry}':
      return MaterialPageRoute<dynamic>(builder: (BuildContext context) {
        final Object? args = settings.arguments;
        final ItemEntryIntentHolder itemEntryIntentHolder =
            (args as ItemEntryIntentHolder? ?? ItemEntryIntentHolder)
                as ItemEntryIntentHolder;
        return ItemOfferEntryContainerView(
          flag: itemEntryIntentHolder.flag,
          item: itemEntryIntentHolder.item,
        );
      });
