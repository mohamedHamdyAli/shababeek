...
// Singleton instance
  ...
  void loadValueHolder() {
    ...
    final String? _userPasswordConfirmToVerify =
        shared.getString(PsConst.VALUE_HOLDER__USER_PASSWORD_TO_VERIFY);
    ...
    final String _adsStatus =
        shared.getString(PsConst.VALUE_HOLDER__ADS_STATUS) ?? '';
    ...
    final PsValueHolder _valueHolder = PsValueHolder(
      ...
      userPasswordConfirmToVerify: _userPasswordConfirmToVerify,
  ...
  Future<dynamic> replaceItemUploadConfig(
    ...
    await shared.setString(PsConst.VALUE_HOLDER__ADS_STATUS, adsStatus);
